...
class DependencyInjection {
  ...
  static Future<void> init() async {
    ...
    try {
      ...
      _repositoryManager.register<N8nPacienteRepository>(N8nPacienteRepository(_httpClient));
      _repositoryManager.register<N8nProfissionalRepository>(N8nProfissionalRepository(_httpClient));
      _repositoryManager.register<N8nConsultasRepository>(N8nConsultasRepository(_httpClient));
